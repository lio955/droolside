...
public class DroolsTokenMaker extends AbstractTokenMaker {
    ...
    public TokenMap getWordsToHighlight() {
        ...
        tokenMap.put("rule", Token.RESERVED_WORD);
        tokenMap.put("when", Token.RESERVED_WORD);
        tokenMap.put("then", Token.RESERVED_WORD);
        tokenMap.put("end", Token.RESERVED_WORD);

        tokenMap.put("insert", Token.FUNCTION);
        tokenMap.put("insertLogical", Token.FUNCTION);
        tokenMap.put("retract", Token.FUNCTION);
        tokenMap.put("update", Token.FUNCTION);
